...
Crear un gráfico de IET para las muestras tomadas en todas las estaciones contenidas en el conjunto de datos (usando las funciones `iet` y `g_iet` del paquete):
