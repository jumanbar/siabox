...
- `nombre_clave`: la abreviación que usa actualmente el SIA y sus aplicaciones; está presente en la tabla `sia_parametro`.
- `param`: en caso de estar disponible, el código alternativo designado (`codigos_param$codigo_nuevo`) y en caso contrario, el `nombre_clave`.
